...
import { Music, Package, Download, Calendar } from "lucide-react";
...
export function PurchaseCard({
    ...
    return (
        <div className="group relative block overflow-hidden rounded-2xl bg-zinc-900/60 backdrop-blur-sm border border-zinc-800/60 hover:border-emerald-500/40 transition-all duration-300 p-6">
            ...
            <div className="mb-4">
                ...
                <div className="flex items-center gap-4 text-xs text-zinc-600">
                    ...
                    <span className="px-2 py-0.5 rounded bg-zinc-800/60 text-zinc-400 font-semibold uppercase tracking-wide">
                        {typeLabel}
                    </span>
                </div>
            </div>
