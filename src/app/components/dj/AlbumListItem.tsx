...
import { Package, Edit, Trash2, Calendar, DollarSign, HardDrive } from "lucide-react";
...
export function AlbumListItem({
    ...
    return (
        <div className="group relative block overflow-hidden rounded-2xl bg-zinc-900/60 backdrop-blur-sm border border-zinc-800/60 hover:border-amber-500/40 transition-all duration-300 p-6">
