...
from .notification_views import (
    ...
    admin_experiment_stats,
    admin_list_experiments,
...
urlpatterns = [
    ...
    path(
        "admin/experiments/<int:experiment_id>/status/", admin_update_experiment_status, name="admin_experiment_status"
    ),
