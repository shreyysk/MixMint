...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, related_name="insurance", to="commerce.purchase"
                    ),
                ),
                (
                    "user",
                    models.ForeignKey(
                        ...
                        related_name="download_insurances",
                        to="accounts.profile",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="download_logs", to="accounts.profile"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(fields=["token"], name="downloads_d_token_2778ff_idx"),
                    models.Index(
                        condition=models.Q(("is_used", False)), fields=["expires_at"], name="idx_download_tokens_expiry"
                    ),
                ],
            },
        ),
