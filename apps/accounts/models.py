...
class DJProfile(models.Model):
    ...
    # profile_setup, payout_setup, first_track, completed
    onboarding_step = models.CharField(max_length=50, default="profile_setup")
...
class Profile(models.Model):
    ...
    pro_plan_type = models.CharField(
        max_length=10, choices=(("monthly", "Monthly"), ("annual", "Annual")), null=True, blank=True
    )
    ...
    referred_by = models.ForeignKey(
        "accounts.DJProfile", on_delete=models.SET_NULL, null=True, blank=True, related_name="referrals"
    )
...
class IPBlacklist(models.Model):
    ...
    type = models.CharField(
        max_length=10, choices=(("ip", "IP Address"), ("cidr", "CIDR Range"), ("device", "Device Fingerprint"))
    )
    value = models.CharField(max_length=100)
    reason = models.TextField(null=True, blank=True)
    added_by = models.ForeignKey(
        Profile, on_delete=models.SET_NULL, null=True, blank=True, related_name="blacklisted_ips"
    )
    is_active = models.BooleanField(default=True)
    created_at = models.DateTimeField(auto_now_add=True)
