...
def download_invoice_pdf(request, invoice_id):
    ...
    try:
        ...
        # Footer
        elements.append(Paragraph("This is a system-generated GST invoice. No signature required.", subtitle_style))
        elements.append(
            Paragraph(
...
def dj_gst_export_csv(request):
    ...
    writer.writerow(
        ["Invoice Number", "Date", "Buyer Name", "Subtotal (INR)", "GST Rate (%)", "GST Amount (INR)", "Total (INR)"]
    )
