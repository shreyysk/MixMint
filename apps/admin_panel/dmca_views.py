...
It has come to my attention that your service is hosting/distributing unauthorized copies
of this work without my consent. This activity constitutes copyright infringement.
...
"""
    ...
    return JsonResponse({"template": template, "dj_name": dj_name, "content_title": content_title})
